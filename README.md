...
Data engineering, architecture, analytics, AI, systems engineering and application development.

This GitHub contains selected examples of architecture, code, systems engineering, data work, and technical curriculum spanning current projects and historical professional work.

### Selected Work

- **[modern_stack](https://github.com/thepocock/modern_stack)** — Conceptual Cloud Solution Architecture <kbd>ARCHITECTURE</kbd>
- **[bbTux](https://github.com/thepocock/bbTux)** — Fedora 44 KDE Linux distribution with reproducible workstation installer and custom bootstrap architecture <kbd>SYSTEMS ENGINEERING</kbd>
- **[query_plan_optimization](https://github.com/thepocock/query_plan_optimization)** — Query optimization case study using execution-plan analysis, staged materialization, and controlled decomposition of complex analytical SQL <kbd>QUERY OPTIMIZATION</kbd>
