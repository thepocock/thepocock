...
This GitHub contains selected examples of architecture, code, systems work, and technical curriculum from my professional work, including historical SQL and Python examples.

### Selected Work

- **[modern_stack](https://github.com/thepocock/modern_stack)** — Conceptual Cloud Solution Architecture <kbd>ARCHITECTURE</kbd>
- **[bbTux]([https://github.com/psstpsst-ai/bbtux](https://github.com/thepocock/bbTux)** — Fedora 44 KDE Linux distribution with reproducible workstation installer and custom bootstrap architecture <kbd>SYSTEMS</kbd>
